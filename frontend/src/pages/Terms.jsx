            ...
            <div className="max-w-4xl mx-auto bg-white border-4 border-[#1A1A1A] p-8 md:p-12 shadow-[8px_8px_0px_#1A1A1A]">
                ...
                <div className="space-y-6 text-sm md:text-base leading-relaxed text-[#1A1A1A]/80">
                    ...
                    <section>
                        ...
                        <p>Welcome to Promptly ("we", "us", "our"). By accessing or using our platform, website, and services, you agree to be bound by these Terms and Conditions ("Terms"). If you do not agree with any part of these terms, you must not use our services.</p>
                    </section>

                    <section>
                        <h2 className="font-heading font-bold text-2xl mb-3 text-[#1A1A1A]">2. The Platform</h2>
                        <p>Promptly is a marketplace connecting creators of AI prompts ("Creators") with users seeking to purchase access to these prompts ("Buyers"). We provide the infrastructure for hosting, selling, and executing these digital goods.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5 space-y-2">
                            ...
                            <li>Promptly is not liable for any loss or damage arising from your failure to protect your login credentials.</li>
                        </ul>
                    </section>

                    <section>
                        <h2 className="font-heading font-bold text-2xl mb-3 text-[#1A1A1A]">4. Intellectual Property & Prompt Ownership</h2>
                        <p><strong>For Creators:</strong> By uploading a prompt to Promptly, you retain all ownership rights to your original prompt engineering. You grant Promptly a worldwide, non-exclusive, royalty-free license to host, display, and sell access to your prompt on our platform.</p>
                    ...
                    <section>
                        ...
                        <p>All financial transactions are processed securely via our third-party payment provider, <strong>Dodo Payments</strong>. Promptly does not directly store your credit card information.</p>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5 space-y-2">
                            ...
                            <li>Attempt to reverse-engineer, scrape, or hack the Promptly platform.</li>
                    ...
                    <section>
                        ...
                        <p>Promptly is provided on an "AS IS" and "AS AVAILABLE" basis. We do not guarantee that prompts will produce specific or desired results on third-party AI models (e.g., ChatGPT, Midjourney, Claude) as AI systems are inherently unpredictable. In no event shall Promptly be liable for any indirect, incidental, special, consequential, or punitive damages arising out of your use of the platform.</p>
                    </section>
